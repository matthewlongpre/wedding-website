...
class Home extends React.Component {
  ...
  render() {
    return (
      <AppContextConsumer>
        {context =>
          <div ref={bgElement => this.bgElement = bgElement} className={`bg-1 page-home page-background w-100 h-100 flex flex-direction-column justify-content-center align-items-center`}>
